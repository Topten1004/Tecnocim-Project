...
namespace vue_backend.Controllers
{
    ...
    {
        /// <summary>
        /// Devuelve la lista de todas las equivalencias moneda.
        /// </summary>
        /// <returns>Lista de todas las equivalencias moneda.</returns>
        ...
        //[Authorize]
        [HttpGet("equivalencias/moneda")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        public async Task<IActionResult> GetAllEquivalenciasMonedas()
        {
            var equivalencias = await _mediator.Send(new GetAllEquivalenciasMonedaQuery());
        ...
        /// <summary>
        /// Devuelve la equivalencia moneda con el identificador pasado por parámetro.
        /// </summary>
        /// <returns>La equivalencia moneda con el identificador pasado por parámetro.</returns>
        /// <response code="200">Operación correcta.</response>
        /// <response code="400">Se ha producido un error en la petición.</response>
        /// <response code="401">El usuario debe estar autenticado y autorizado.</response>
        /// <response code="404">No se ha encontrado la equivalencia entidad con ese identificador.</response>
        //[Authorize]
        [HttpGet("equivalencias/moneda/{id}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        public async Task<IActionResult> GetEquivalenciaMonedaById(int id)
        {
            var equivalencia = await _mediator.Send(new GetEquivalenciaMonedaByIdQuery(id));
