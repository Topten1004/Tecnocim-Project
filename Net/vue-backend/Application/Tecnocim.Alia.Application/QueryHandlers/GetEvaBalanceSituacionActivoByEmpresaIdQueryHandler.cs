...
public class GetEvaBalanceSituacionActivoByEmpresaIdQueryHandler : IRequestHandler<GetEvaBalanceSituacionActivoByEmpresaIdQuery,
    GenericResult<BalanceSituacionResponse>>
{
    private readonly ILogger<GetEvaBalanceSituacionActivoByEmpresaIdQueryHandler> _logger;
    private readonly IServiceProvider _serviceProvider;
    private readonly IMapper _mapper;

    public GetEvaBalanceSituacionActivoByEmpresaIdQueryHandler(
        ILogger<GetEvaBalanceSituacionActivoByEmpresaIdQueryHandler> logger,
    ...
    public async Task<GenericResult<BalanceSituacionResponse>> Handle(GetEvaBalanceSituacionActivoByEmpresaIdQuery request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var conceptosContabilidad = new List<string> {
                ...
                "periodificaciones a corto plazo activo",
            ...
            if (documentos is { } && documentos.Any())
            {
                ...
                var ingresosGastos = new BalanceSituacionResponse { Nombre = "Balance de situación - Activo", List = list, Columnas = columnas };
        ...
        {
            var message = $"Error al obtener el balance de situación activo para la empresa con id: {request.EmpresaId}";
